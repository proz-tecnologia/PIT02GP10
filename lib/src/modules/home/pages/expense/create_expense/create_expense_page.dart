...
class _CreateExpensePageState extends State<CreateExpensePage> {
  final createExpenseController = Modular.get<CreateExpensePageController>();
  ...
  void initState() {
    createExpenseController.createExpenseStateNotifier.addListener(() {
      if (createExpenseController.state is CreateExpensePageStateSuccess) {
        Modular.to.pop(true);
      } else if (createExpenseController.state is CreateExpensePageStateError) {
        final e = createExpenseController.state as CreateExpensePageStateError;
        if (e.error != null) {
          ...
          child: Form(
            ...
            child: Column(
              children: [
                ...
                ValueListenableBuilder<CreateExpensePageState>(
                  valueListenable:
                  ...
                  builder: (context, state, _) {
                    return SizedBox(
                      ...
                      child: CustomElevatedButton(
                        ...
                        child: state is CreateExpensePageStateLoading
